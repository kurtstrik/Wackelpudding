...
public class TutorialActivity extends Activity implements OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        GameView = new TutorialSurfaceView(this);
        ...
        background = MediaPlayer.create(this, R.raw.wiishop);
    ...
    private class LoadView extends AsyncTask<Void, Integer, Void>
    {
        ...
        {
            progress = ProgressDialog.show(TutorialActivity.this,getResources().getString(R.string.loadingtitle),
                    getResources().getString(R.string.loadtutorial), false, false);
        }
          ...
          Quelle fuer Dialogmenu: http://www.helloandroid.com/tutorials/how-display-custom-dialog-your-android-application */
                ...
                public void onClick(View v) {
                    ...
                    //Code aus: http://stackoverflow.com/questions/2969242/problems-with-mediaplayer-raw-resources-stop-and-start
                       ...
                       /*falls Musik aus ist, soll ein neues "Lied"-Objekt zugeteilt werden
                        ...
                        background = MediaPlayer.create(getApplicationContext(), R.raw.wiishop);
                        background.setVolume(0.3f, 0.3f);
                        background.start();
                        musik.setText(getResources().getString(R.string.dialog2));
                        GameView.setmedia(background);
            ...
            help.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    dialog2 = new Dialog(TutorialActivity.this);
            ...
            menu.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent myIntent = new Intent(TutorialActivity.this, Hauptmenu.class);
