...
public class Level2Activity extends Activity implements OnClickListener, SeekBar.OnSeekBarChangeListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		GameView = new SurfaceViewlv2(this);
		...
		background = MediaPlayer.create(this, R.raw.choroq);
	...
	private class LoadView extends AsyncTask<Void, Integer, Void>
	{
		...
		{
			progress = ProgressDialog.show(Level2Activity.this,getResources().getString(R.string.loadingtitle),
					getResources().getString(R.string.loadstage2), false, false);
		}
	...
	public void onClick(View arg0) {
		...
		/*falls pausiert wird, soll der MainThread0 nicht updaten und ein Dialog Fenster aufgerufen werden |
          ...
          Quelle fuer Dialogmenu: http://www.helloandroid.com/tutorials/how-display-custom-dialog-your-android-application */
			...
			dialog = new Dialog(Level2Activity.this);
		...
		//	dialog.setCanceledOnTouchOutside(true);
			...
			musik.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					//Code aus: http://stackoverflow.com/questions/2969242/problems-with-mediaplayer-raw-resources-stop-and-start
						...
						background = MediaPlayer.create(getApplicationContext(), R.raw.choroq);
						background.setVolume(0.25f, 0.25f);
						background.start();
						GameView.setmedia(background);
						musik.setText(getResources().getString(R.string.dialog2));
			...
			help.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					dialog2 = new Dialog(Level2Activity.this);
			...
			menu.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Intent myIntent = new Intent(Level2Activity.this, Hauptmenu.class);
