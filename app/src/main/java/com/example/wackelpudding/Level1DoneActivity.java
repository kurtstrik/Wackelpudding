...
public class Level1DoneActivity extends Activity implements OnClickListener{
	private Button next;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		next = (Button)findViewById(R.id.lv1nextlvl);
        next.setOnClickListener(this);
        
        
        
        menu =(Button)findViewById(R.id.lv1main);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_level1_done, menu);
		return true;
	}*/
    ...
    public void onClick(View v) {
		//nimmt den boolean Wert aus dem vorherigen Aufruf und gibt diesen weiter
        	...
        	if (v==next) {
	        	Intent myIntent = new Intent(this, Level2Activity.class);
